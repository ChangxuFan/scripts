...
ifiles=list.files(path=idir, pattern="m\\.chr1_22_X_Y.CTSS$", full.names=T)
ifiles=ifiles[ifiles!="/scratch/jmaeng/TE_TF_cancer/TE_gene_chimericreads/peak/deepseq_final/nanoCAGE_H2228_LatePassage_Brep1.starAligned.sortedByCoord.out.umi.dedup.filt.bam.chr1_22_X_Y.CTSS"]
print( length(ifiles) )
...
ifiles2=list.files(path=idir, pattern="G\\.chr1_22_X_Y.CTSS$", full.names=T)
