#!/bin/bash -e
if [ $# -ne 7 ]; then
    echo "usage v1: lrna_align_star_pe_se.sh <star_index_directory> <read1.fq.gz> <library_id> <ncpus><out_put_dir><root_name_for_bam_file>"
...
bam_root="$6_star" # root name for output bam (e.g. "out_bam" will create "out_bam_star_genome.bam" and "out_bam_star_anno.bam") 
outdir=$5
...
echo "-- Map reads..."
set -x
STAR --genomeDir $star_index --readFilesIn $read1_fq_gz                               \
